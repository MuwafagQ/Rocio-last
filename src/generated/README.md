...
This README will guide you through the process of using the generated JavaScript SDK package for the connector `rocio-mobile-sdk`. It will also provide examples on how to use your generated SDK to call your Data Connect queries and mutations.
...
A connector is a collection of Queries and Mutations. One SDK is generated for each connector - this SDK is generated for the connector `rocio-mobile-sdk`. You can find more information about connectors in the [Data Connect documentation](https://firebase.google.com/docs/data-connect#how-does).

You can use this generated SDK by importing from the package `@firebasegen/rocio-mobile-sdk-connector` as shown below. Both CommonJS and ESM imports are supported.
...
Below are examples of how to use the `rocio-mobile-sdk` connector's generated functions to execute each query. You can also follow the examples from the [Data Connect documentation](https://firebase.google.com/docs/data-connect/web-sdk#using-queries).
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getUser, GetUserVariables } from '@firebasegen/rocio-mobile-sdk-connector';
...
import { connectorConfig, getUserRef, GetUserVariables } from '@firebasegen/rocio-mobile-sdk-connector';
...
## ListBrands
You can execute the `ListBrands` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListBrandsData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listBrands } from '@firebasegen/rocio-mobile-sdk-connector';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, listBrandsRef } from '@firebasegen/rocio-mobile-sdk-connector';
...
## ListProducts
You can execute the `ListProducts` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `ListProductsData`, which is defined in [generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, listProductsRef } from '@firebasegen/rocio-mobile-sdk-connector';
...
Below are examples of how to use the `rocio-mobile-sdk` connector's generated functions to execute each mutation. You can also follow the examples from the [Data Connect documentation](https://firebase.google.com/docs/data-connect/web-sdk#using-mutations).
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, upsertUser, UpsertUserVariables } from '@firebasegen/rocio-mobile-sdk-connector';
...
// Variables can be defined inline as well.
const { data } = await upsertUser({ id: ..., nameAr: ..., phone: ..., });
...
import { connectorConfig, upsertUserRef, UpsertUserVariables } from '@firebasegen/rocio-mobile-sdk-connector';
...
// Variables can be defined inline as well.
const ref = upsertUserRef({ id: ..., nameAr: ..., phone: ..., });
